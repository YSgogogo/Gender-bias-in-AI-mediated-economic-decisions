...
%%%%%%%%%%%%%%%%%%
% Where we get Figure 4a (Distribution of AI’s decision in the give framing)
%%%%%%%%%%%%%%%%%%
...
for i = 1:2
    filename = ['output_max_', num2str(i), '.xlsx'];
...
saveas(gcf, 'ChatGPT-4o-give-distribution_max.png');
