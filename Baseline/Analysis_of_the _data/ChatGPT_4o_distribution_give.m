...
%%%%%%%%%%%%%%%%%%
% Where we get Figure 1a (Distribution of AI’s decision in the give framing)
%%%%%%%%%%%%%%%%%%
...
female_counts = histcounts(female_give, bins);
male_counts = histcounts(male_give, bins);
unspecified_counts = histcounts(unspecified_give, bins);

female_prop = 100 * female_counts / length(female_give);
male_prop = 100 * male_counts / length(male_give);
unspecified_prop = 100 * unspecified_counts / length(unspecified_give);
...
saveas(gcf, 'ChatGPT-4o-give-distribution.png');
